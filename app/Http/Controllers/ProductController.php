...
class ProductController extends Controller
{
    ...
    public function filter(Request $request)
    {
        if ($request->ajax()) {
            ...
            $price = str_replace('.', '', json_decode($request->get('price'))); // Menghapus titik pada filter harga
                            ...
                            <a href="product/' . $product->id . '">
                                <div class="card-body">
                                    <div class="product-info">
                                        ...
                                        <div class="info-3"><h5>IDR ' . number_format($product->price, 0, ',', '.') . '</h5></div>
                                    </div>
                                </div>
                            </a>
                        </div>
    ...
    public function create(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            'category' => 'required|in:Shoes,Running Shoes,Sport Shoes',
        ]);
