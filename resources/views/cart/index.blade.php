                    ...
                    <div class="row">
                        @foreach ($products as $product)
                            <div class="col-12 d-flex p-2 justify-content-between cart-item">
                                ...
                                <div class="item-quantity">IDR {{ $product['price'] }}</div>
                            </div>
                        @endforeach
                    </div>
                        ...
                        <div class="card-body">
                            <div class="cart-checkout">
                                ...
                                <div class="info-4 pt-3">
                                    <a href="{{ route('product.index') }}"><button class="button w-100">Lanjutkan berbelanja</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container p-0 ">
        <div class="row">
            <div class="col-12 d-flex flex-column justify-content-center align-items-center empty-cart">
                ...
                <div><h4><b>Yahhhh, sayangnya keranjang Anda Masih Kosong.</b></h4></div>
                <div><a href="{{ route('product.index') }}">Yuk cari sepatu impian kamu disini</a></div>
            </div>
        </div>
    </div>
