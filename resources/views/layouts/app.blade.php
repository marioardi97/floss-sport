...
<head>
    ...
    <title>Dashboard Admin | Floss Sport</title>
            ...
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <div class="d-flex">
                        ...
                        <div class="pl-3 ml-3 pt-2" style="border-left:1px solid rgba(0, 0, 0, 0.5); font-size:1.5rem;">Floss Sport</div>
                    </div>
                </a>
            ...
            <div class='container p-0 pt-3'>
                <div class='row'>
                    <div class='col-md-4 col-sm-12 pt-3'>
                        ...
                        <p>STMIK Mercusuar <br> Bekasi <br> +123456789 <br> customercare@mercusuar.ac.id</p>
                    </div>
                    <div class='col-md-4 col-sm-12 pt-3'>
                        <h3>Ikuti Kami</h3>
                        <ul>
                    ...
                    <div class='col-md-4 col-sm-12 pt-3'>
                        <h3>Berlangganan Katalog Email</h3>
                        <p>Daftar untuk mendapatkan informasi dari email.</p>
                    ...
                    <div class='col-md-6 col-sm-12 copyright'>
                        <p>Dibuat untuk UTS E-commerce</p>
                        <p>Sistem Informasi &copy; 2024. All Rights Reserved</p>
                    </div>
